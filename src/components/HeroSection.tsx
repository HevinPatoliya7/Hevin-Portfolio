        ...
        <div className="flex flex-1 items-center">
          <div className="w-full max-w-7xl px-6 md:px-10">
            ...
            <FadeIn delay={0.5} y={40}>
              <h1
                className="leading-[0.85] tracking-tight text-white flex flex-col items-start"
                style={{ fontSize: 'clamp(3.5rem, 12vw, 11rem)' }}
              >
                <span className="italic text-[#D7E2EA]/90 ml-1 sm:ml-2" style={{ fontFamily: '\"Playfair Display\", serif', fontSize: '0.65em', letterSpacing: '-0.02em', marginBottom: '-0.1em' }}>I'm</span>
                <span className="font-black uppercase">Hevin</span>
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={1.0} y={20}>
              <div className="mt-8 flex items-center gap-4">
                <a
                  href="#projects"
                  className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-white px-6 py-3 sm:px-8 sm:py-3.5 text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-black transition-transform hover:scale-[1.03] active:scale-[0.98]"
                >
                  <span className="relative z-10">Explore Work</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-black/10 to-transparent translate-x-[-100%] transition-transform duration-500 group-hover:translate-x-[100%]" />
                </a>
                <a
                  href="#about"
                  className="group inline-flex items-center justify-center rounded-full border border-white/20 bg-white/5 px-6 py-3 sm:px-8 sm:py-3.5 text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-white backdrop-blur-md transition-all hover:bg-white/10 hover:border-white/40 active:scale-[0.98]"
                >
                  About Me
                </a>
              </div>
